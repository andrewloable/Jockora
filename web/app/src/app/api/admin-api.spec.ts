...
describe('AdminApi', () => {
  ...
  const cases: Array<[string, () => void, string, string, unknown?]> = [
    ...
    [
      'public listener',
      () => api.setPublicListener(true).subscribe(),
      'POST',
      '/admin/public-listener',
      { public_listener: true },
    ],
    ['recall', () => api.setRecall(true).subscribe(), 'POST', '/admin/recall', { recall: true }],
    ['redo dossiers', () => api.redoDossiers().subscribe(), 'POST', '/admin/redo-dossiers', {}],
