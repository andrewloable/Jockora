...
var matrix = []expectation{
	...
	{method: http.MethodPost, path: "/admin/public-listener", role: auth.RoleAdmin, body: `{"public_listener":true}`},
	{method: http.MethodPost, path: "/admin/recall", role: auth.RoleAdmin, body: `{"recall":true}`},
	{method: http.MethodPost, path: "/admin/redo-dossiers", role: auth.RoleAdmin, body: `{}`},
